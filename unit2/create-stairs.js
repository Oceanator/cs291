...
function createStairs() {
	...
	var cupY = 1725;
	var stairY = verticalStepHeight + stepThickness;
	var stairNum = 0;
	...
	while(stairY < cupY){
		...
		stepMesh.position.y = stairNum*verticalStepHeight + verticalStepHeight/2 + stairNum * stepThickness;	// half of height: put it above ground plane
		stepMesh.position.z = stairNum*horizontalStepDepth - stairNum * stepThickness;			// centered at origin
		scene.add( stepMesh );
		...
		stepMesh.position.y = (stairNum + 1) * verticalStepHeight + (stairNum + 1) * stepHalfThickness + stairNum * stepHalfThickness;
		// Push step forward by half the depth, minus half the vertical step's thickness
		stepMesh.position.z = stairNum * horizontalStepDepth + horizontalStepDepth/2 - stairNum * stepThickness - stepHalfThickness;
		scene.add( stepMesh );

		stairNum++;
		stairY = stairY + verticalStepHeight + stepThickness;
	}
}
